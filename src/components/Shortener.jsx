    ...
    return (
        <>
            ...
            >
                ...
                <div
                    className="flex justify-center flex-col items-center bg-white text-center md:flex-row
                md:justify-between p-3 mt-3 rounded-lg shadow"
                >
                    <article>
                        <h6 className="ml-4 mb-3 md:mb-0">
                            {links.original_link}
                        </h6>
                    </article>
                    ...
                    <article>
                        <ul className="flex md:items-center">
                            ...
                            <li>
                                <button
                                    onClick={handleCopy}
                                    className="btn-cta rounded-lg text-sm focus:bg-slate-800 hover:bg-cyan-700 ml-2"
                                >
                                    {buttonText}
                                </button>
                            </li>
